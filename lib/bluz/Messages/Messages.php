...
class Messages extends Options
{
    ...
    public function addNotice($text)
    {
        ...
        $store[self::TYPE_NOTICE][] = Translator::translate($text);
    ...
    public function addSuccess($text)
    {
        ...
        $store[self::TYPE_SUCCESS][] = Translator::translate($text);
        return $this;
    }
    ...
    public function addError($text)
    {
        ...
        $store = $this->getMessagesStore();
        $store[self::TYPE_ERROR][] = Translator::translate($text);
        return $this;
    }
