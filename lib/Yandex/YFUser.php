...
class YFUser {	
    ...
    function testConnect($url = "api/users/"){
        $connect = new YFConnect();

        $base = "http://api-fotki.yandex.ru/";
        ...
        $массив_свойств_объекта_simplexml  = get_object_vars($sxml);

        return $массив_свойств_объекта_simplexml;
    }
	...
	public function getServiceDocument(){
        ...
        //http://api-fotki.yandex.ru/api/users/{author}
        //http://api-fotki.yandex.ru/api/users/babagai
	...
	public function authenticate($password){
		...
		$this->rsaKey = $массив_свойств_объекта_simplexml['key'];
		//$this->requestId = $sxml->request_id;
		$this->requestId = $массив_свойств_объекта_simplexml['request_id'];
        ...
        if( !isset($массив_свойств_объекта_simplexml['token']) ){
            throw new YFXMLException($xml, E_ERROR,"Не удалось получить токен","canNotCreateXML");
        }

        $token = $массив_свойств_объекта_simplexml['token'];
