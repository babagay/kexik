...
class YFAlbumCollection {	
     ...
     *
     * @param array $args ассоциативный массив, в котором хранятся аргументы,
     *                    значения которых отличаются от значений по умолчанию.
     *                    Ключи ассоциативного массива: order, time, id, limit, token.
     *                    Точное описание аргументов смотрите в описании метода search
     *
     * @return void
	 * @access public
	 */
