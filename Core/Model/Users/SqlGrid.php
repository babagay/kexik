...
class SqlGrid extends \Bluz\Grid\Grid
{
    ...
    public function init()
    {
        ...
        $this->setAllowOrders(array('id', 'login', 'name', 'phone', 'email', 'created', 'updated', 'status', 'credit', 'discount', 'orders_to_bonus', 'presents'));
        $this->setAllowFilters(array('id', 'login', 'email', 'status', 'name', 'phone'));
