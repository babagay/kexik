...
return
    ...
    function () {
        ...
        <div class="basket"><a
                href="<?php echo $link_basket; ?>"> <?php echo $header_basket; ?> <?php echo $in_basket; ?> </a></div>
        <div class="partners">
            ...
            <div class="cabnet-form">
                <div class="select-cabnet"><a href="кабинет" id="cabinet_header">Личный
                    ...
                    <ul class="select-no-display">
                        ...
                        <li><a href="кабинет/мои_заказы">Мои заказы</a></li>
                        <li><a href="кабинет/пополнение">Пополнение счёта</a></li>
                    </ul>
                </div>
