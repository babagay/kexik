...
class ZoqaTwigExtension extends \Twig_Extension{
    ...
    function ahref($param_1 = null, $param_2 = null, $param_3 = null)
    {   
        $глазурь = $this->getClosure(__METHOD__);
    ...
    function api_closure($extra_params = array()){
        return function ($module, $method = null, $params = array()) use($extra_params) {
            /*
            $app = app()->getInstance();
            $view = $app->getView();
            // или
